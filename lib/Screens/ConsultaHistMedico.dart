...
class SearchHistMedico extends StatefulWidget{
  String data;
  String currentUser;
  @override
  _SearchHistMedicoState createState() => _SearchHistMedicoState();
  SearchHistMedico({
    this.data,
    this.currentUser
  });
...
class _SearchHistMedicoState extends State<SearchHistMedico> {
  ...
  Widget _carList(){
    if (record != null) {
      ...
      for(var y = 0; y < record.documents.length; y++){
        if(record.documents[y].data['codigo'] == widget.data&&record.documents[y].data['tipo'] == 'salud'){
          carflag = true;
          location.add(y);
        }
      }
                        ...
                        children: <Widget>[
                          Center(
                            child: Container(
                                ...
                                child: Image(image: AssetImage('assets/images/histmedico.png'))),
                          ),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                                  ...
                                  children: <Widget>[
                                    ...
                                    Flexible(
                                      child: Container(
                                        ...
                                        child:Text('Tiempo Prox. Aplicación: ${(record.documents[location[i]].data['fechaApliProx'].toDate()).difference(DateTime.now()).inDays.toString()} días',style: new TextStyle(fontSize: 20.0),),
                                      ),
                                    ),
